...
//  DesignCodeSwiftUI
//
//  Created by Vinicius Carvalho Marques on 28/05/20.
    ...
    var body: some View {
        ...
        .overlay(
            Circle()
                ...
                .stroke(LinearGradient(gradient: Gradient(colors: [Color(press ? #colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1) : #colorLiteral(red: 0.4196078431, green: 0.2980392157, blue: 0.9490196078, alpha: 1)), Color(press ? #colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1) : #colorLiteral(red: 0.2196078449, green: 0.007843137719, blue: 0.8549019694, alpha: 1))]), startPoint: .topTrailing, endPoint: .bottomLeading), style: StrokeStyle(lineWidth: 5, lineCap: .round))
